...
.brand .tag {{ margin-left: auto; font-family: GM, monospace; font-size: 13px; letter-spacing: 0.14em; text-transform: uppercase; color: #e6c88a; border: 1px solid rgba(230,200,138,0.45); border-radius: 999px; padding: 8px 16px; background: rgba(5,7,10,0.62); }}
.knight {{ position: absolute; right: 55px; top: 70px; height: 960px; width: auto; filter: drop-shadow(0 0 60px rgba(34,227,224,0.45)) drop-shadow(0 0 140px rgba(34,227,224,0.18)); }}
.eyebrow {{ position: relative; text-shadow: 0 0 8px rgba(5,7,10,1), 0 0 20px rgba(5,7,10,0.95), 0 2px 16px rgba(5,7,10,0.9); margin-top: 64px; font-family: GM, monospace; font-size: 22px; letter-spacing: 0.32em; text-transform: uppercase; color: #22e3e0; display: flex; align-items: center; gap: 14px; }}
...
.days {{ position: relative; text-shadow: 0 0 8px rgba(5,7,10,1), 0 2px 14px rgba(5,7,10,0.9); margin-top: -18px; font-family: GM, monospace; font-size: 34px; letter-spacing: 0.42em; text-transform: uppercase; color: #f2f6f8; }}
.days span {{ color: #838f9c; }}
h1 {{ position: relative; text-shadow: 0 2px 18px rgba(5,7,10,0.85); margin: 36px 0 0; max-width: 460px; font-size: 50px; line-height: 1.04; letter-spacing: -0.035em; font-weight: 600; color: #f2f6f8; text-wrap: balance; }}
